...
keys = [
    ...
    Key([], "XF86AudioLowerVolume", lazy.spawn('pactl set-sink-volume @DEFAULT_SINK@ -2%'), desc="Lower Audio Volume"),
    Key([], "XF86AudioRaiseVolume", lazy.spawn('pactl set-sink-volume @DEFAULT_SINK@ +2%'), desc="Raise Audio Volume"),
    Key([], "XF86AudioMute", lazy.spawn('pactl set-sink-mute @DEFAULT_SINK@ toggle'), desc="Raise Audio Volume"),
    Key([], "XF86MonBrightnessUp", lazy.spawn('brightnessctl s +5%'), desc="Raise Monitor Brightness"),
    Key([], "XF86MonBrightnessDown", lazy.spawn('brightnessctl s 5%-'), desc="Raise Monitor Brightness"),
]

# Definition of KeyChords
# -----------------------
...
keys.extend([
    KeyChord([mod], "s", [
        ...
        Key([], "d", lazy.spawn("shutdown -h now")),
...
widget_defaults = dict(
    font="NotoSansM Nerd Font Condensed Rgular",
    fontsize=14,
    padding=3,
)
...
wl_input_rules = {"type:keyboard": InputConfig(kb_layout="ch", kb_variant= "fr"),}
